<div class="container">
	<div class="hero-unit">
		...
		<h2>Gagne !</h2><br>
		<center>
		<p class="lead"><b>Félicitations, tu as gagné une place pour le match de rugby le Parc/Pau le samedi 20 avril !</b> <br>Présente ce flyer à l'entrée du Bal pour obtenir ton lot.</p>
